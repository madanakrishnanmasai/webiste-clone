...
Courses_Data_Base.forEach(function(course){
  ...
  men_img.src = "https://cdn4.iconfinder.com/data/icons/social-communication/142/users-512.png";
...
Courses_Data_Base.forEach(function(course){
  ...
  btn.onclick = function(event) {
    //   console.log("Click to view program")
    window.location.href = 'http://127.0.0.1:5501/rough-draft/upgrade-clone-2/block-chain.html'
  }
